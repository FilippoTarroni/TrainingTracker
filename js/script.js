...
document.addEventListener("DOMContentLoaded", () => {
    // ELEMENTI DOM
    const btnAggiungi = document.querySelector(".aggiungiAttivita");
    ...
    function aggiornaInterfaccia(){
        ...
        if(allenamento && ultimoAllenamento){
            if(headerAllenamento){
                headerAllenamento.textContent = `Allenamento - ${allenamento.tipoAllenamento}`;
            }
        ...
        attivitaSalvate.forEach(att => {
            ...
            if(att.tipo === "allenamento"){
                ...
                if(att.tipoAllenamento === "ripetute"){
                    ...
                    infoSpecifiche = `${att.km || ""} km @ ${att.ritmo || "-"} /km (Tempo: ${att.tempo || ""})`;
                }
